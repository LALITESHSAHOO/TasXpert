...
public class IntroActivity extends AppIntro2 {
	...
	public void onDonePressed() {
		EventsRefresher.getAppContext().getSharedPreferences(Constants.PREFS_NAME, Context.MODE_MULTI_PROCESS).edit()
	...
	public static boolean mustRun() {
		return !EventsRefresher.isDebugBuild() && !EventsRefresher.getAppContext().getSharedPreferences(Constants.PREFS_NAME,
