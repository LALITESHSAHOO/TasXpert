...
import com.lalitesh.datenoteapp.utils.ConnectionManager;
...
public class UpdaterTask extends AsyncTask<String, Void, Void> {
	...
	protected void onPreExecute() {
		...
		if (EventsRefresher.isDebugBuild() || !ConnectionManager.internetAvailable(EventsRefresher.getAppContext()) || now < prefs.getLong(Constants
