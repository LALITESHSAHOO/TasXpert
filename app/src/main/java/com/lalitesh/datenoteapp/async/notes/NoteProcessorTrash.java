...
import com.lalitesh.datenoteapp.utils.ShortcutHelper;
...
public class NoteProcessorTrash extends NoteProcessor {
    ...
    protected void processNote(Note note) {
        if (trash) {
            ShortcutHelper.removeshortCut(EventsRefresher.getAppContext(), note);
            ReminderHelper.removeReminder(EventsRefresher.getAppContext(), note);
        } else {
