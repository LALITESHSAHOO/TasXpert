...
public class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getArguments() != null && getArguments().containsKey(XML_NAME)) {
			xmlId = ResourcesUtils.getXmlId(EventsRefresher.getAppContext(), ResourcesUtils.ResourceIdentifiers.xml, String
...
//		});
		...
		if (lang != null) {
			...
			lang.setOnPreferenceChangeListener((preference, value) -> {
				EventsRefresher.updateLanguage(getActivity(), value.toString());
