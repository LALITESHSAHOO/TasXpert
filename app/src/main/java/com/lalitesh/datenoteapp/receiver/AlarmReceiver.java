...
package com.lalitesh.datenoteapp.receiver;
...
import com.lalitesh.datenoteapp.SnoozeActivity;
import com.lalitesh.datenoteapp.db.DbHelper;
import com.lalitesh.datenoteapp.models.Note;
import com.lalitesh.datenoteapp.services.NotificationListener;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	private void createNotification(Context mContext, Note note) {
		...
		notificationsHelper.getBuilder()
				.addAction(R.drawable.ic_material_reminder_time_light, com.lalitesh.datenoteapp.utils.TextHelper
						.capitalize(mContext.getString(R.string.snooze)) + ": " + snoozeDelay, piSnooze)
				.addAction(R.drawable.ic_remind_later_light,
						com.lalitesh.datenoteapp.utils.TextHelper.capitalize(mContext.getString(R.string
