...
public class Navigation {
    ...
    public static int getNavigation() {
        String[] navigationListCodes = EventsRefresher.getAppContext().getResources().getStringArray(R.array.navigation_list_codes);
    ...
    public static String getNavigationText() {
        Context mContext = EventsRefresher.getAppContext();
    ...
    public static Long getCategory() {
        if (getNavigation() == CATEGORY) {
			return Long.valueOf(EventsRefresher.getAppContext().getSharedPreferences(Constants.PREFS_NAME, Context
