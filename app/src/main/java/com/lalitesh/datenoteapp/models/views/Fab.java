...
package com.lalitesh.datenoteapp.models.views;
...
import com.lalitesh.datenoteapp.fab.FloatingActionButton;
import com.lalitesh.datenoteapp.fab.FloatingActionsMenu;

import it.feio.android.checklistview.utils.DensityUtil;
import com.lalitesh.datenoteapp.EventsRefresher;
import com.lalitesh.datenoteapp.R;
import com.lalitesh.datenoteapp.models.listeners.AbsListViewScrollDetector;
import com.lalitesh.datenoteapp.models.listeners.OnFabItemClickedListener;
...
public class Fab {
    ...
    private void init() {
        ...
        FloatingActionButton fabAddButton = (FloatingActionButton) fab.findViewById(R.id.fab_expand_menu_button);
      ...
      //  fab.findViewById(R.id.fab_sketch).setOnClickListener(onClickListener);
        fab.findViewById(R.id.fab_backup).setOnClickListener(onClickListener);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int navBarHeight = Display.getNavigationBarHeightKitkat(EventsRefresher.getAppContext());
            FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) fab.getLayoutParams();
            params.setMargins(params.leftMargin, params.topMargin, params.rightMargin,
                    navBarHeight + DensityUtil.pxToDp(params.bottomMargin, EventsRefresher.getAppContext()));
    ...
    public void setOverlay(int colorResurce) {
        View overlayView = new View(EventsRefresher.getAppContext());
