...
import com.lalitesh.datenoteapp.async.TextWorkerTask;
            ...
            if (note.isChecklist()) {
               ...
               // holder.content.setText(titleAndContent[1]);
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                    holder.content.setText(Html.fromHtml(htmlString,Html.FROM_HTML_MODE_LEGACY));
                } else {
                    holder.content.setText(Html.fromHtml(htmlString));
                }
                holder.title.setText(titleAndContent[0]);
