...
public abstract class WidgetProvider extends AppWidgetProvider {
    ...
    public static final String EXTRA_WORD = "com.lalitesh.datenoteapp.widget.WORD";
    public static final String TOAST_ACTION = "com.lalitesh.datenoteapp.widget.NOTE";
    public static final String EXTRA_ITEM = "com.lalitesh.datenoteapp.widget.EXTRA_FIELD";
