...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mButtonSpacing = (int) (getResources().getDimension(com.lalitesh.datenoteapp.R.dimen.fab_actions_spacing) - getResources().getDimension(com.lalitesh.datenoteapp.R.dimen.fab_shadow_radius) - getResources().getDimension(com.lalitesh.datenoteapp.R.dimen.fab_shadow_offset));
        mLabelsMargin = getResources().getDimensionPixelSize(com.lalitesh.datenoteapp.R.dimen.fab_labels_margin);
        mLabelsVerticalOffset = getResources().getDimensionPixelSize(com.lalitesh.datenoteapp.R.dimen.fab_shadow_offset);
        ...
        TypedArray attr = context.obtainStyledAttributes(attributeSet, com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu, 0, 0);
//        mAddButtonPlusColor = attr.getColor(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(android.R.color.white));
        mAddButtonColorNormal = attr.getColor(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, getColor(com.lalitesh.datenoteapp.R.color.default_normal));
        mAddButtonColorPressed = attr.getColor(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, getColor(com.lalitesh.datenoteapp.R.color.default_pressed));
        mAddButtonSize = attr.getInt(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_addButtonSize, FloatingActionButton.SIZE_NORMAL);
        mAddButtonStrokeVisible = attr.getBoolean(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_addButtonStrokeVisible, true);
        mExpandDirection = attr.getInt(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_expandDirection, EXPAND_UP);
        mLabelsStyle = attr.getResourceId(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_labelStyle, 0);
        mLabelsPosition = attr.getInt(com.lalitesh.datenoteapp.R.styleable.FloatingActionsMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);
...
//                mPlusColor = mAddButtonPlusColor;
        ...
        if (mDrawableIcon != null)
            mAddButton.setIconDrawable(mDrawableIcon);
        mAddButton.setId(com.lalitesh.datenoteapp.R.id.fab_expand_menu_button);
    ...
    public void removeButton(FloatingActionButton button) {
        ...
        removeView(button);
        button.setTag(com.lalitesh.datenoteapp.R.id.fab_label, null);
        mButtonsCount--;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (!expandsHorizontally()) {
                TextView label = (TextView) child.getTag(com.lalitesh.datenoteapp.R.id.fab_label);
                if (label != null) {
        ...
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    View label = (View) child.getTag(com.lalitesh.datenoteapp.R.id.fab_label);
                    if (label != null) {
    ...
    private void createLabels() {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (button == mAddButton || title == null ||
                    button.getTag(com.lalitesh.datenoteapp.R.id.fab_label) != null) continue;
            ...
            button.setTag(com.lalitesh.datenoteapp.R.id.fab_label, label);
        }
    }
    ...
    private Drawable getIconDrawable(Context context) {
        final float iconSize = context.getResources().getDimension(com.lalitesh.datenoteapp.R.dimen.fab_icon_size);
        final float iconHalfSize = iconSize / 2f;

        final float plusSize = context.getResources().getDimension(com.lalitesh.datenoteapp.R.dimen.fab_plus_icon_size);
        final float plusHalfStroke = context.getResources().getDimension(com.lalitesh.datenoteapp.R.dimen.fab_plus_icon_stroke) / 2f;
