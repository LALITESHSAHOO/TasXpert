...
public class FloatingActionButton extends android.support.v7.widget.AppCompatImageButton {
  ...
  void init(Context context, AttributeSet attributeSet) {
    TypedArray attr = context.obtainStyledAttributes(attributeSet, com.lalitesh.datenoteapp.R.styleable.FloatingActionButton, 0, 0);
    mColorNormal = attr.getColor(com.lalitesh.datenoteapp.R.styleable.FloatingActionButton_fab_colorNormal, getColor(com.lalitesh.datenoteapp.R.color.default_normal));
    mColorPressed = attr.getColor(com.lalitesh.datenoteapp.R.styleable.FloatingActionButton_fab_colorPressed, getColor(com.lalitesh.datenoteapp.R.color.default_pressed));
    mColorDisabled = attr.getColor(com.lalitesh.datenoteapp.R.styleable.FloatingActionButton_fab_colorDisabled, getColor(com.lalitesh.datenoteapp.R.color.default_disabled));
    mSize = attr.getInt(com.lalitesh.datenoteapp.R.styleable.FloatingActionButton_fab_size, SIZE_NORMAL);
    mIcon = attr.getResourceId(com.lalitesh.datenoteapp.R.styleable.FloatingActionButton_fab_icon, 0);
    mTitle = attr.getString(com.lalitesh.datenoteapp.R.styleable.FloatingActionButton_fab_title);
    mStrokeVisible = attr.getBoolean(com.lalitesh.datenoteapp.R.styleable.FloatingActionButton_fab_stroke_visible, true);
    attr.recycle();

    updateCircleSize();
    mShadowRadius = getDimension(com.lalitesh.datenoteapp.R.dimen.fab_shadow_radius);
    mShadowOffset = getDimension(com.lalitesh.datenoteapp.R.dimen.fab_shadow_offset);
    updateDrawableSize();
  ...
  private void updateCircleSize() {
    mCircleSize = getDimension(mSize == SIZE_NORMAL ? com.lalitesh.datenoteapp.R.dimen.fab_size_normal : com.lalitesh.datenoteapp.R.dimen.fab_size_mini);
  }
  ...
  */
  ...
  TextView getLabelView() {
    return (TextView) getTag(com.lalitesh.datenoteapp.R.id.fab_label);
  }
  ...
  void updateBackground() {
    final float strokeWidth = getDimension(com.lalitesh.datenoteapp.R.dimen.fab_stroke_width);
    final float halfStrokeWidth = strokeWidth / 2f;

    LayerDrawable layerDrawable = new LayerDrawable(
        new Drawable[] {
            getResources().getDrawable(mSize == SIZE_NORMAL ? com.lalitesh.datenoteapp.R.drawable.fab_bg_normal : com.lalitesh.datenoteapp.R.drawable.fab_bg_mini),
            createFillDrawable(strokeWidth),
            createOuterStrokeDrawable(strokeWidth),
            getIconDrawable()
        });

    int iconOffset = (int) (mCircleSize - getDimension(com.lalitesh.datenoteapp.R.dimen.fab_icon_size)) / 2;
