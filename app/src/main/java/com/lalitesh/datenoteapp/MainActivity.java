...
import com.lalitesh.datenoteapp.async.UpdaterTask;
...
import com.lalitesh.datenoteapp.intro.IntroActivity;
...
import com.lalitesh.datenoteapp.utils.SystemHelper;
...
public class MainActivity extends BaseActivity implements OnDateSetListener, OnTimeSetListener {
    ...
    private static final int SELECT_PICTURE = 8000 ;
   ...
   // private TextView tx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN); */
		setTheme(R.style.EventsRefresherTheme_ApiSpec);
       ...
       // tx = (TextView) findViewById(R.id.navdrawer_title);

      /*  Button b = (Button) findViewById(R.id.set_name);
        ...
        b.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert.setTitle("Name To Display");
        ...
        String s1 = sp.getString("imguri",s);
        if(s1!=null) {
            Picasso.with(MainActivity.this).load(s1).transform(new CircleTransform())
                    .into((ImageView) findViewById(R.id.profpic));
        }
        else
        {
            Picasso.with(MainActivity.this).load(R.drawable.prof).transform(new CircleTransform())
                    .into((ImageView) findViewById(R.id.profpic));
        }
   ...
   public void img(View V) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == SELECT_PICTURE) {
                ...
                Picasso.with(MainActivity.this).load(selectedImageURI).transform(new CircleTransform())
                        .into((ImageView) findViewById(R.id.profpic));
                SharedPreferences sp =
                        getSharedPreferences("MyPrefs",
                                Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sp.edit();
                s = selectedImageURI.toString();
                editor.putString("imguri", s);
                editor.commit();
    ...
    private  final  Uri test = selectedImageURI;

   /* public void name_set(View v)
    {
