...
package com.lalitesh.datenoteapp.services;
...
import com.lalitesh.datenoteapp.async.bus.NotificationRemovedEvent;
...
public class NotificationListener extends NotificationListenerService {
	...
	public static boolean isRunning() {
		...
		ContentResolver contentResolver = EventsRefresher.getAppContext().getContentResolver();
