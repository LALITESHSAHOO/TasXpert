...
package com.lalitesh.datenoteapp.helpers.date;
...
public class DateHelper {
    ...
    public static String getNoteReminderText(long reminder) {
        return EventsRefresher.getAppContext().getString(R.string.alarm_set_on) + " " + getDateTimeShort(EventsRefresher
				.getAppContext(), reminder);
    }


    public static String getNoteRecurrentReminderText(long reminder, String rrule) {
        return DateHelper.formatRecurrence(EventsRefresher.getAppContext(), rrule) + " " + EventsRefresher.getAppContext().getString
                (R.string.starting_from) + " " + DateHelper.getDateTimeShort(EventsRefresher.getAppContext(), reminder);
    }


	public static String getFormattedDate(Long timestamp, boolean prettified) {
		if(prettified) {
			return com.lalitesh.datenoteapp.utils.date.DateUtils.prettyTime(timestamp);
		} else {
			return DateHelper.getDateTimeShort(EventsRefresher.getAppContext(), timestamp);
		}
	}
